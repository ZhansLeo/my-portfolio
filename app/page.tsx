      ...
      <section className="mb-28">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {[
            ...
            <div
              key={group.title}
              className="rounded-lg border border-gray-100 bg-white p-6 shadow-sm transition hover:shadow-md hover:-translate-y-0.5"
            >
      ...
      <section className="mb-28">
        ...
        <div className="space-y-6">
          {[
            ...
            <div
              key={project.name}
              className="rounded-lg border border-gray-100 bg-white p-8 shadow-sm transition hover:shadow-md hover:-translate-y-0.5"
            >
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                {project.link && (
                  <a
                    ...
                    className="ml-auto font-mono text-xs text-blue-600 underline underline-offset-2 transition hover:text-blue-500"
                  >
                    体验 →
                  </a>
                )}
